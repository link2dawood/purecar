...
function updateDropdownText(value, dropdownId, inputId, displayLabel = null) {
    ...
    if(inputId == 'makeInput'){
        ...
        fetchVariants(window.currentFilters.make, value);
    }
    ...
    window.currentFilters[filterName] = value;
...
function updateAllDropdowns() {
    ...
    const fieldsToUpdate = ['pricefrom', 'priceto', 'yearfrom', 'yearto', 'bodytype', 'enginesize', 'fueltype', 'gearbox', 'doors', 'colors', 'sellertype', 'maxmiles'];
    ...
    .then(data => {
        ...
        fieldsToUpdate.map((fieldName)=>{
            ...
            if (data[dataKey]) {
                updateDropdownOptions(fieldName, data[dataKey]);
            }
        });
    })
