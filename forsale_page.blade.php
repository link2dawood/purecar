...
#sortList  .dropdown-item{
 ...
 <section class="text-center pt-4 pt-lg-5" >
     <div class="card-list-container">
         <div class="d-flex justify-content-between align-items-center" id="topbarpadding" style="display:none !important;">
             ...
             <div class="dropdown custom-dropdown sort-dropdown">
                <button class="btn dropdown-toggle w-100 d-flex justify-content-between align-items-center gap-2"
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.8335 17.5V15" stroke="#FFFCFC" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M14.1665 17.5V12.5" stroke="#FFFCFC" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M14.1665 5V2.5" stroke="#FFFCFC" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M5.8335 7.5V2.5" stroke="#FFFCFC" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M5.8335 15C5.05693 15 4.66865 15 4.36235 14.8732C3.95398 14.704 3.62952 14.3795 3.46036 13.9712C3.3335 13.6648 3.3335 13.2766 3.3335 12.5C3.3335 11.7234 3.3335 11.3352 3.46036 11.0288C3.62952 10.6205 3.95398 10.296 4.36235 10.1268C4.66865 10 5.05693 10 5.8335 10C6.61006 10 6.99835 10 7.30464 10.1268C7.71301 10.296 8.03747 10.6205 8.20663 11.0288C8.3335 11.3352 8.3335 11.7234 8.3335 12.5C8.3335 13.2766 8.3335 13.6648 8.20663 13.9712C8.03747 14.3795 7.71301 14.704 7.30464 14.8732C6.99835 15 6.61006 15 5.8335 15Z" stroke="#FFFCFC" stroke-width="1.25"/>
                            <path d="M14.1665 10C13.3899 10 13.0017 10 12.6953 9.87317C12.287 9.704 11.9625 9.3795 11.7933 8.97117C11.6665 8.66483 11.6665 8.27657 11.6665 7.5C11.6665 6.72343 11.6665 6.33515 11.7933 6.02886C11.9625 5.62048 12.287 5.29602 12.6953 5.12687C13.0017 5 13.3899 5 14.1665 5C14.9431 5 15.3313 5 15.6377 5.12687C16.046 5.29602 16.3705 5.62048 16.5397 6.02886C16.6665 6.33515 16.6665 6.72343 16.6665 7.5C16.6665 8.27657 16.6665 8.66483 16.5397 8.97117C16.3705 9.3795 16.046 9.704 15.6377 9.87317C15.3313 10 14.9431 10 14.1665 10Z" stroke="#FFFCFC" stroke-width="1.25"/>
                        </svg>
                    <span class="dropdown-text">Filter & Sort</span>
                </button>
                <ul class="dropdown-menu overflow-auto" id="sortList">
                    <li>
                        <a class="dropdown-item" onclick="setSortOption('newest')" href="javascript:void(0)">Most Recent</a>
                    </li>
                    <li>
                        <a class="dropdown-item" onclick="setSortOption('low-high')" href="javascript:void(0)">Price (low to high)</a>
                    </li>
                    <li>
                        <a class="dropdown-item" onclick="setSortOption('high-low')" href="javascript:void(0)">Price (high to low)</a>
                    </li>
                    <li>
                        <a class="dropdown-item" onclick="setSortOption('mileage')" href="javascript:void(0)">Mileage (low to high)</a>
                    </li>
                </ul>
            </div>
         </div>
     ...
     <div class="search-filter-bar">
        ...
        <button class="bar-section arrow-section" onclick="scrollToTop()">
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7.5 0.5V14.5M7.5 0.5L0.5 7.5M7.5 0.5L14.5 7.5" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </button>
    </div>
 </section>
                 ...
                 <form method="GET" action="{{ route('search_car') }}">
                     ...
                     <div style="display: flex; align-items: center; gap: 10px; margin-top: 10px;" class="paddingmobile">
                         ...
                         <div class="dropdown w-100">
                             ...
                             <input type="hidden" name="model" id="modelInput" value="{{ $modelselected ?? '' }}">
                         </div>
                     </div>
                     ...
                     <div style="display: flex; align-items: center; gap: 10px; margin-top: 10px;" class="paddingmobile">
                         ...
                         <div class="dropdown w-100">
                             ...
                             <input type="hidden" name="variant" id="variantInput" value="{{ $variantselected ?? '' }}">
                         </div>
                     </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 10px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="year_from" id="yearFromInput" value="{{ $yearfromselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 10px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="year_to" id="yearToInput" value="{{ $yeartoselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 10px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="price_from" id="pricefromInput" value="{{ $pricefromselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 10px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="price_to" id="pricetoInput" value="{{ $pricetoselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 10px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="fuel_type" id="fuel_typeInput" value="{{ $fuel_typeselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 10px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="miles" id="milesInput" value="{{ $milesselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 10px;" class="paddingmobile"> 
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="gear_box" id="gear_boxInput" value="{{ $gear_boxselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 10px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="seller_type" id="seller_typeInput" value="{{ $seller_typeselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 5px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="body_type" id="body_typeInput" value="{{ $body_typeselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 5px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="doors" id="doorsInput" value="{{ $doorsselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 12px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="engine_size" id="engine_sizeInput" value="{{ $engine_sizeselected ?? '' }}">
                             </div>
                         </div>
                         ...
                         <div style="display: flex; align-items: center; gap: 12px;" class="paddingmobile">
                             ...
                             <div class="dropdown w-100">
                                 ...
                                 <input type="hidden" name="colors" id="colorsInput" value="{{ $colorsselected ?? '' }}">
                             </div>
                         </div>
    ...
    window.onload = function() {
        ...
        if (makeselected) {
            ...
            if (document.getElementById('makeDropdown')) {
                if (document.getElementById('makeDropdown').textContent.trim() !== makeselected.trim()) {
...
function applyPriceFilter() {
    ...
    if(isMount){
        ...
        queryParamsCount = urlParams.toString();
    }
